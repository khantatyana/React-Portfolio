...
function About() {
    ...
    return (
        <div>
            ...
            experiences on the web. Earned a certificate in Full Stack Development from the Columbia Engineering,
            where I developed skills in JavaScript - MERN - MongoDB / Express / React / Node - Jest JS / ES6 / jQuery, MySQL,
